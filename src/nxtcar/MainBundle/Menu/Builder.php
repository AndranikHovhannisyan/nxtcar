...
class Builder extends ContainerAware
{
    ...
    public function profileMenu(FactoryInterface $factory, array $options)
    {
        ...
        $menu['Profile']->addChild('Photo', array('route' => ''));
        $menu['Profile']->addChild('Preferences', array('route' => ''));
        $menu['Profile']->addChild('Car', array('route' => ''));
        $menu['Profile']->addChild('Password', array('route' => ''));
